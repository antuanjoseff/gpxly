...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get reverseTrackMessage =>
      'Parece que estás siguiendo el track en dirección inversa. ¿Quieres invertirlo para mejorar la navegación?';
  ...
  String get deleteTrackMessage =>
      '¿Estás seguro de que quieres eliminar esta ruta importada? Esta acción no se puede deshacer.';
  ...
  String get notificationPermissionMessage =>
      'Senda necesita mostrar una notificación mientras grabas la ruta. Esto evita que el sistema detenga la aplicación para ahorrar batería y garantiza que no pierdas tu track.';
