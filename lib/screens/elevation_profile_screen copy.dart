...
class _ElevationProfileScreenState
  ...
  Widget _buildHeader(
    ...
    // Alçada proporcional, igual que el gràfic
    final headerHeight = MediaQuery.of(context).size.height * 0.12;
    ...
    return SizedBox(
      ...
      child: Center(
        child: selectedIndex == null
            ...
            : FittedBox(
                fit: BoxFit.scaleDown, // 🔥 evita desbordaments
                child: Column(
                  children: [
                    Text(
