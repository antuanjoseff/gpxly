...
class _AlarmSettingsTabState extends ConsumerState<AlarmSettingsTab> {
  ...
  Widget _buildAlarmCard({
    ...
    if (progress == null || !isActive) {
      progressValue = 0.0;
    } else if (title == t.alarmsDistanceTitle) {
      progressValue = progress.distance;
    } else if (title == t.alarmsAltitudeTitle) {
      progressValue = progress.altitude;
    } else {
      progressValue = progress.time;
    }
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Switch.adaptive(
                value: isActive,
                activeThumbColor: AppColors.primary, // abans activeColor
